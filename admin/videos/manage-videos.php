                        ...
                        <tbody>
                            ...
                            <?php while ($video = mysqli_fetch_assoc($get_videos)) { ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit-video.php?id=<?php echo $video['id']; ?>" class="btn btn-sm edit">
                                            Edit
                                        </a>

                                        <a href="delete-video.php?id=<?php echo $video['id']; ?>" class="btn btn-sm delete" onclick="return confirm('Are you sure?')">
                                            Delete
                                        </a>
